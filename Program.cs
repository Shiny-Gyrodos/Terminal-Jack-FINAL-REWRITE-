    ...
    class Game
    {
        ...
        public static void Hit(bool dealerOrPlayer) // False is the player, true is the dealer
        {
            ...
            if (dealerOrPlayer == false) // Player draw card
            {
                ...
                {
                    randomCard = 1; // All aces are 11 by default, but if one causes you to bust, its value is set to 1 instead
                }
            ...
            else if (dealerOrPlayer == true) // Dealer draw card
            {
                ...
                {
                    randomCard = 1; // All aces are 11 by default, but if one causes the dealer to bust, its value is set to 1 instead
                }
